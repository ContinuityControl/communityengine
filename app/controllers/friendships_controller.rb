class FriendshipsController < BaseController
  ...
  def denied
    @user = User.find(params[:user_id])    
    @friendships = @user.friendships.paginate(:conditions => ["friendship_status_id = ?", FriendshipStatus[:denied].id], :page => params[:page])
  ...
  def accepted
    ...
    @friendships = @user.friendships.accepted.paginate :per_page => 12, :page => params[:page], :total_entries => @friend_count
