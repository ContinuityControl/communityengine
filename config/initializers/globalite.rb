...
I18n.load_path += Dir[ (Rails.root.join("vendor", "plugins", "community_engine", "lang", "ui", '*.{rb,yml}').to_s) ] - I18n.load_path
I18n.load_path += Dir[ (Rails.root.join("lang", "ui", '*.{rb,yml}').to_s) ] - I18n.load_path
